...
class BanqueC 
{
    ...
    function ajouterBanque($banque)
    {
        	...
        	$sql="insert into Banque(cardName,cardNumber,expirationMonth,expirationYear,CVV,login) values (:cardName,:cardNumber,:expirationMonth,:expirationYear,:CVV,:login)";
		...
		$req->bindValue(':login',$banque->getLogin());
        if($req->execute()){
            echo"ok";
        }else{
            echo "non";
