                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-lg-7">
                            ...
                            <div class="row">
                                <div class="col-md-6"><p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus</p>
                                </div><!-- End .col-md-6 -->
                                <div class="col-md-6">
                                    <p>Been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book. It has survived not only five centuries It was popularised in the 1960s with the release of Letraset sheets containing Lorem Ipsum passages, and more recently with desktop publishing software like Aldus.</p>
                                </div><!-- End .col-md-6 -->
                            </div><!-- End .row -->
                        </div><!-- End .col-lg-7 -->
                    </div><!-- End .row -->
            ...
            <div class="features-section">
                <div class="container-fluid">
                    <div class="title-group text-center">
                        <h2 class="subtitle">OUR SPECIAL FEATURES</h2>
                        <p>Lorem ipsum is simply dummy text</p>
                    </div>
                    
                    <div class="row">
                        <div class="col-md-6 col-lg-3">
                            <div class="info-box info-box-wrap">
                ...
                <div class="container-fluid">
                    ...
                    <div class="team-carousel owl-carousel owl-theme">
                        ...
                        <div class="member">
                            ...
                            <h3 class="member-title">Lee DOE</h3>
                        </div><!-- End .member -->

                        <div class="member">
                            <img src="assets/images/team/member-4.jpg" alt="member">

                            <h3 class="member-title">David DOE</h3>
                        </div><!-- End .member -->
                        <div class="member">
                            <img src="assets/images/team/member-5.jpg" alt="member">

                            <h3 class="member-title">Susan DOE</h3>
                        </div><!-- End .member -->

                        <div class="member">
                            <img src="assets/images/team/member-6.jpg" alt="member">

                            <h3 class="member-title">Alan DOE</h3>
                        </div><!-- End .member -->
