...
FROM adressetotal where login=:login";
...
<body>
                        ...
                        <div class="checkout-payment">
                            ...
                            <div id="new-checkout-address" class="show ">
                                ...
                                <form action="" method="post" id="informations">
                                    ...
                                    <input type="button" value="valider" class="btn btn-primary float-right " onclick="showSwal('success-message')" bouton="1">
                            ...
                            <div id="new-checkout-address" class="show ">
                                ...
                                <form action="" method="post" id="paiement">
                                    ...
                                    <input type="button" value="valider" class="btn btn-primary float-right " onclick="showSwal('success-message')" bouton="2">
                                        ...
                                        <div class="modal-body">
                                            <div id="new-checkout-address" class="show ">
                                                ...
                                                <form action="" method="post" id="informations2">
                                                    ...
                                                    <input type="button" value="valider" class="btn btn-primary float-right " onclick="showSwal('success-message')" bouton="3">
                            ...
                            <a href=""><button type="button" class="btn btn-primary float-right " style="margin-top:50px;">Commander</button></a>
    ...
    <script>
        $(function() {
            ...
            var idPanier="<?php echo $_SESSION['idPanier']?>";
