              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="owl-carousel owl-theme full-width">
                    <div class="item">
                      <img src="https://via.placeholder.com/485x303" alt="banner image"/>
                    </div>
                    <div class="item">
                      <img src="https://via.placeholder.com/485x303" alt="banner image"/>
                    </div>
                  ...
                  <div class="owl-carousel owl-theme full-width">
                    <div class="item">
                      <div class="card text-white">
                        <img class="card-img" src="https://via.placeholder.com/485x303" alt="Card image">
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="owl-carousel owl-theme loop">
                    <div class="item">
                      <img src="https://via.placeholder.com/256x160" alt="banner image"/>
                    </div>
                    <div class="item">
                      <img src="https://via.placeholder.com/256x160" alt="banner image"/>
                    </div>
              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="owl-carousel owl-theme rtl-carousel">
                    <div class="item">
                      <img src="https://via.placeholder.com/203x126" alt="banner image"/>
                    </div>
                    <div class="item">
                      <img src="https://via.placeholder.com/203x126" alt="banner image"/>
                    </div>
