            ...
            <div class="col-lg-12">
              <div class="card">
                <div class="card-body">
                  <div class="row">
                    <div class="col-md-4">
                      <button class="btn btn-primary btn-block"><i class="icon-plus"></i> Create A New event</button>
                      ...
                      <div class="wrapper">
                        <div class="wrapper d-flex justify-content-between align-items-center mb-4">
                          ...
                          <span class="text-gray"><i class="icon-options"></i></span>
                        </div>
                        <div class="calendar-aside">
                          <div class="list">
                            <img class="img-xs rounded-circle" src="https://via.placeholder.com/37x37" alt="profile image">
                            <span class="user-text">Luke Pachytel</span>
                            <span class="count online ml-auto">
                              <i class="close ml-auto icon-close"></i>
                            </span>
                          </div>
                          <div class="list">
                            <img class="img-xs rounded-circle" src="https://via.placeholder.com/37x37" alt="profile image">
