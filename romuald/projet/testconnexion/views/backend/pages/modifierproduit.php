                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputNom" placeholder="Nom"  value="zied">
                    </div>
                    <div class="form-group">
                      <label for="exampleDescription">Description</label>
                      <textarea class="form-control" id="exampleDescription" rows="4"></textarea>
                    </div>

                    <div class="form-group">
                      <label for="exampleInputType">Fournisseur</label>
                      <select class="form-control">
                          <option> P%JBS%OVBùsouvmoubS
                          <option> mk1jvbsvmbSUVBM
                          <option> %sbvmobSVMBsvbmiuBV
                          <option>mKJBVmbQDVMBmqdbv
