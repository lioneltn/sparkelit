...
$listeFournisseur=$fournisseurC->afficherFournisseurParRef($_POST['reference']);
...
<body>
	...
	<div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="../../modifierFournisseur.php" onsubmit="return controleform()">
                    <div class="form-group">
                      <label for="exampleInputID">Nom</label>
                      <input type="text" class="form-control" id="exampleInputID" placeholder="Nom" name="reference" value="<?php echo $listeFournisseur['reference'];?>" required readonly>
                    </div>


                    <div class="form-group">
                      <label for="exampleAdresse">Pays</label>
                      <input type="text" class="form-control" id="Pays" placeholder="Pays" name="pays" maxlength="50" value="<?php echo $listeFournisseur['pays'];?>" required onfocusout="controlePays()">
                      <span class="Erreur"></span>
                    </div>

                    <div class="form-group">
                      <label for="exampleAdresse">Region</label>
                      <input type="text" class="form-control" id="Region" placeholder="Region" name="region" maxlength="50"  value="<?php echo $listeFournisseur['region'];?>" required onfocusout="controleRegion()">
                      <span class="Erreur"></span>
                    </div>

                    <div class="form-group">
                      <label for="exampleNumber">Ville</label>
                      <input type="text" class="form-control" id="Ville" placeholder="Ville" name="ville" maxlength="50" value="<?php echo $listeFournisseur['ville'];?>" required onfocusout="controleVille()">
                      <span class="Erreur"></span>
                    </div>

                    <div class="form-group">
                      <label for="exampleEmail">Email</label>
                      <input type="email" class="form-control" id="Email" placeholder="Email" name="email" maxlength="50"  value="<?php echo $listeFournisseur['email'];?>" required>
                    </div>

                    <div class="form-group">
                      <label for="exampleNumber">Numero</label>
                      <input type="text" class="form-control" id="Numero"  placeholder="Numero" name="numero" maxlength="50"  value="<?php echo $listeFournisseur['numero'];?>" required onfocusout="controleNumero()">
                      <span class="Erreur"></span>
                    </div>


                    <button type="submit" id="ajouter" class="btn btn-primary mr-2" onclick="validerfournisseur()">Modifier</button>
...
<script src="../vendors/js/vendor.bundle.base.js"></script>
  ...
  <script type="text/javascript">
    ...
    {
      if(controleRegion() && controlePays() && controleVille() && controleNumero())
      {
        return true;
      }
      else
