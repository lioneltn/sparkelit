...
<body>
  ...
  <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" action="../../../ajouterposteBD.php" method="POST" enctype="multipart/form-data">
                   ...
                   <div class="form-group">
                      ...
                      <textarea class="form-control" id="Discription" name="description" rows="4" required></textarea>
                    </div>
                    <div class="card">
                <div class="card-body">
