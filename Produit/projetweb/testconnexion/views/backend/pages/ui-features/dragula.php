                        ...
                        <div id="profile-list-left" class="py-2">
                          <div class="card rounded mb-2">
                            <div class="card-body p-3">
                              <div class="media">
                                <img src="https://via.placeholder.com/40x40" alt="image" class="img-sm mr-3 rounded-circle">
                    ...
                    <div class="col-md-6">
                      ...
                      <div id="dragula-left" class="py-2">
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-note icon-sm align-self-center mr-3"></i>
                              <div class="media-body">
                        ...
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-envelope icon-sm align-self-center mr-3"></i>
                              <div class="media-body">
                        ...
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-cloud-upload icon-sm align-self-center mr-3"></i>
                              <div class="media-body">
                        ...
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-plane icon-sm align-self-center mr-3"></i>
                              <div class="media-body">
                    ...
                    <div class="col-md-6">
                      ...
                      <div id="dragula-right" class="py-2">
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-user icon-sm align-self-center mr-3"></i>
                              <div class="media-body">
                        ...
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-login icon-sm align-self-center mr-3"></i>
                              <div class="media-body">
                        ...
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-calendar icon-sm align-self-center mr-3"></i>
                              <div class="media-body">
                    ...
                    <div class="col-md-6">
                      ...
                      <div id="dragula-event-left" class="py-2">
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-check icon-sm text-primary align-self-center mr-3"></i>
                              <div class="media-body">
                                <h6 class="mb-1">Build wireframe</h6>
                                <p class="mb-0 text-muted">
                                  Build wireframe for the new app
                    ...
                    <div class="col-md-6">
                      ...
                      <div id="dragula-event-right" class="py-2">
                        <div class="card rounded border mb-2">
                          <div class="card-body p-3">
                            <div class="media">
                              <i class="icon-check icon-sm text-success align-self-center mr-3"></i>
                              <div class="media-body">
                                <h6 class="mb-1">Project details</h6>
                                <p class="mb-0 text-muted">
                                  Get new project details from Greg
