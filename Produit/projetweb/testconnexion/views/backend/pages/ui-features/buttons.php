                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <div class="template-demo">
                        <button type="button" class="btn btn-icons btn-rounded btn-light"><i class="icon-home"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-secondary"><i class="icon-settings"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-success"><i class="icon-envelope"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-primary"><i class="icon-star"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-warning"><i class="icon-location-pin"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-info"><i class="icon-action-undo"></i></button>
                        <br>
                        <button type="button" class="btn btn-icons btn-inverse-light"><i class="icon-home"></i></button>
                        <button type="button" class="btn btn-icons btn-inverse-secondary"><i class="icon-settings"></i></button>
                        <button type="button" class="btn btn-icons btn-inverse-success"><i class="icon-envelope"></i></button>
                        <button type="button" class="btn btn-icons btn-inverse-primary"><i class="icon-star"></i></button>
                        <button type="button" class="btn btn-icons btn-inverse-warning"><i class="icon-location-pin"></i></button>
                        <button type="button" class="btn btn-icons btn-inverse-info"><i class="icon-action-undo"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <div class="template-demo">
                        <button type="button" class="btn btn-icons btn-rounded btn-outline-light"><i class="icon-home"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-outline-secondary"><i class="icon-settings"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-outline-success"><i class="icon-envelope"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-outline-primary"><i class="icon-star"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-outline-warning"><i class="icon-location-pin"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-outline-info"><i class="icon-action-undo"></i></button>
                        <br>
                        <button type="button" class="btn btn-icons btn-rounded btn-inverse-outline-light"><i class="icon-home"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-inverse-outline-secondary"><i class="icon-settings"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-inverse-outline-success"><i class="icon-envelope"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-inverse-outline-primary"><i class="icon-star"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-inverse-outline-warning"><i class="icon-location-pin"></i></button>
                        <button type="button" class="btn btn-icons btn-rounded btn-inverse-outline-info"><i class="icon-action-undo"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <div class="template-demo">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <button type="button" class="btn btn-outline-secondary"><i class="icon-heart"></i></button>
                          <button type="button" class="btn btn-outline-secondary"><i class="icon-calendar"></i></button>
                          <button type="button" class="btn btn-outline-secondary"><i class="icon-clock"></i></button>
                        </div>
                      </div>
                      <div class="template-demo">
                        <div class="btn-group" role="group" aria-label="Basic example">
                        ...
                        <div class="btn-group" role="group" aria-label="Basic example">
                          <button type="button" class="btn btn-primary"><i class="icon-heart"></i></button>
                          <button type="button" class="btn btn-primary"><i class="icon-calendar"></i></button>
                          <button type="button" class="btn btn-primary"><i class="icon-clock"></i></button>
                        </div>
                      </div>
                      <div class="template-demo">
                  ...
                  <div class="col-md-6">
                    <div class="card-body">
                      ...
                      <p class="card-description">Use any of the available button classes to quickly create a styled button.</p>
                      <div class="template-demo">
                        <button type="button" class="btn btn-light btn-fw"><i class="icon-heart"></i>Default</button>
                        <button type="button" class="btn btn-primary btn-fw"><i class="icon-star-outline"></i>Primary</button>
                        <button type="button" class="btn btn-success btn-fw"><i class="icon-check"></i>Success</button>
                        <button type="button" class="btn btn-secondary btn-fw"><i class="icon-notebook"></i>Submit</button>
                        <button type="button" class="btn btn-dark btn-fw"><i class="icon-cloud-download"></i>Edit</button>
                        <button type="button" class="btn btn-danger btn-fw"><i class="icon-exclamation"></i>Warning</button>
                        <button type="button" class="btn btn-info btn-fw"><i class="icon-cloud-upload"></i>Upload</button>
                        <button type="button" class="btn btn-success btn-fw"><i class="icon-printer"></i>Print</button>
                        <button type="button" class="btn btn-light btn-fw"><i class="icon-refresh"></i>Reset</button>
                      </div>
                    </div>
                    <div class="card-body">
                      ...
                      <p class="card-description">Use any of the available button classes to quickly create a styled button.</p>
                      <div class="template-demo">
                        <button type="button" class="btn btn-outline-primary btn-fw"><i class="icon-notebook"></i>Submit</button>
                        <button type="button" class="btn btn-secondary btn-fw"><i class="icon-cloud-download"></i>Edit</button>
                        <button type="button" class="btn btn-outline-danger btn-fw"><i class="icon-exclamation"></i>Warning</button>
                        <button type="button" class="btn btn-outline-info btn-fw"><i class="icon-cloud-upload"></i>Upload</button>
                        <button type="button" class="btn btn-outline-success btn-fw"><i class="icon-printer"></i>Print</button>
                        <button type="button" class="btn btn-outline-light btn-fw"><i class="icon-refresh"></i>Reset</button>
                      </div>
                    </div>
                  </div>
                </div>
                <div class="row">
                  <div class="col-6">
                    <div class="card-body">
                      ...
                      <div class="template-demo">
                        <button type="button" class="btn social-btn btn-facebook"><i class="icon-social-facebook"></i></button>
                        <button type="button" class="btn social-btn btn-twitter"><i class="icon-social-twitter"></i></button>
                        <button type="button" class="btn social-btn btn-dribbble"><i class="icon-social-dribbble"></i></button>
                        <button type="button" class="btn social-btn btn-linkedin"><i class="icon-social-linkedin"></i></button>
                        <button type="button" class="btn social-btn btn-google"><i class="icon-social-google"></i></button>
                        <br>
                        <button type="button" class="btn social-btn btn-social-outline-facebook"><i class="icon-social-facebook"></i></button>
                        <button type="button" class="btn social-btn btn-social-outline-twitter"><i class="icon-social-twitter"></i></button>
                        <button type="button" class="btn social-btn btn-social-outline-dribbble"><i class="icon-social-dribbble"></i></button>
                        <button type="button" class="btn social-btn btn-social-outline-linkedin"><i class="icon-social-linkedin"></i></button>
                        <button type="button" class="btn social-btn btn-social-outline-google"><i class="icon-social-google"></i></button>
                      </div>
                    </div>
                  </div>
                  <div class="col-6">
                    <div class="card-body">
                      ...
                      <div class="template-demo">
                        <button type="button" class="btn social-btn btn-rounded btn-facebook"><i class="icon-social-facebook"></i></button>
                        <button type="button" class="btn social-btn btn-rounded btn-twitter"><i class="icon-social-twitter"></i></button>
                        <button type="button" class="btn social-btn btn-rounded btn-dribbble"><i class="icon-social-dribbble"></i></button>
                        <button type="button" class="btn social-btn btn-rounded btn-linkedin"><i class="icon-social-linkedin"></i></button>
                        <button type="button" class="btn social-btn btn-rounded btn-google"><i class="icon-social-google"></i></button>
                        <br>
                        <button type="button" class="btn social-btn btn-rounded btn-social-outline-facebook"><i class="icon-social-facebook"></i></button>
                        <button type="button" class="btn social-btn btn-rounded btn-social-outline-twitter"><i class="icon-social-twitter"></i></button>
                        <button type="button" class="btn social-btn btn-rounded btn-social-outline-dribbble"><i class="icon-social-dribbble"></i></button>
                        <button type="button" class="btn social-btn btn-rounded btn-social-outline-linkedin"><i class="icon-social-linkedin"></i></button>
                        <button type="button" class="btn social-btn btn-rounded btn-social-outline-google"><i class="icon-social-google"></i></button>
                      </div>
                    </div>
                  </div>
                </div>
