...
<head>
    ...
    <style type="text/css">
        ...
        .config-size-list li label:hover,.config-size-list li label:focus
        {
            color:#fff;
            border-color:#29363c;
            background-color:#29363c;
        }
        .config-size-list li input:focus ~label
        {
            color:#fff;
            border-color:#29363c;
            background-color:#29363c;
                                    ...
                                    <div class="product-slider-container product-item">
                                        <div class="product-single-carousel owl-carousel owl-theme">
                                            <div class="product-item">
                                                <img class="product-single-image" src="../<?php echo $i;?>" />
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image" src="../<?php echo $i1;?>"/>
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image" src="../<?php echo $i2;?>"/>
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image" src="../<?php echo $i3;?>"/>
                                            </div>
                                            <div class="product-item">
                                                <img class="product-single-image" src="../<?php echo $i4;?>"/>
                                            </div>
                                        </div>
                                    ...
                                    <div class="product-single-details">
                                        ...
                                        <div class="product-filters-container">
                                            ...
                                            <ul class="config-size-list">
                                                <li><label  for="small">S</label><input type="radio" name="taille" value="small" id="small"></li>
                                                <li><label  for="Meduim">M</label><input type="radio" name="taille" value="Meduim" id="Meduim"></li>
                                                <li><label for="Large">L</label><input type="radio" name="taille" value="Large" id="Large"></li>
                                                <li><label  for="XtraLarge">XL</label><input type="radio" name="taille" value="XtraLarge" id="XtraLarge"></li>
                                            </ul>
                                        </div><!-- End .product-filters-container -->

                                        <div class="product-action product-all-icons">
                                            <div class="product-single-qty">
                                                <input class="horizontal-quantity form-control" type="number" max="5">
