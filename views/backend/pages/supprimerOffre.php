...
<li class="nav-item">
              <a href="ajouterproduit.php" class="nav-link"><i class="link-icon icon-book-open"></i><span class="menu-title">Offre</span><i class="menu-arrow"></i></a>
              <div class="submenu">
                <ul class="submenu-item">
	...
	<div class="card">
                <div class="card-body">
                  ...
                  chdir(__DIR__);
                   ...
                   <form class="forms-sample" id="MyForms" action="../../supprimerOffre.php" method="POST" enctype="multipart/form-data">
                    
                    <div class="form-group">  
                      <label for="exampleInputID">Identifiant</label>
                     <?php 
                              include '../../afficheridOffre.php';
                       ?>
