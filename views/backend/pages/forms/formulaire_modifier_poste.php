  ...
  <nav class="navbar horizontal-layout col-lg-12 col-12 p-0">
	...
	<div class="card">
                <div class="card-body">
                 ...
                 <form class="forms-sample" action="../../../modifierposteBD.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Titre</label>
                      <div class="col-sm-9">
                        <input type="text" class="form-control" id="Titre" name="titre" placeholder="Titre" value="<?php echo $liste['titre']; ?>">
                      </div>
                    </div>
                   <div class="form-group">
                      <label for="exampleTextarea1">Description</label>
                      <textarea class="form-control" id="Discription" name="description" rows="4" ><?php echo $liste[2]; ?></textarea>
                    </div>
                    <div class="card">
                <div class="card-body">
