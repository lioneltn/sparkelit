...
if($method == 'GET')
{
 ...
 $query = "SELECT * FROM utilisateur u inner join admin a on u.email = a.login WHERE a.type = '1' AND nom LIKE :nom AND prenom LIKE :prenom AND email LIKE :email AND datenaissance LIKE :datenaissance AND sexe LIKE :sexe AND dateAjout LIKE :dateAjout ORDER BY email DESC";
