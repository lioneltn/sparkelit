                    ...
                    <table class="table mb-0">
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td class="pr-0 text-right"><div class="badge badge-pill badge-primary"><i class="icon-user"></i></div></td>
                        </tr>
                        <tr>
                          <td class="pl-0">Outlined Icons</td>
                          <td class="pr-0 text-right"><div class="badge badge-pill badge-outline-info"><i class="icon-cloud-upload"></i></div></td>
                        </tr>
                        <tr>
                          <td class="pl-0">Icon With Text</td>
                          <td class="pr-0 text-right"><div class="badge badge-pill badge-danger"><i class="icon-envelope mr-2"></i>12</div></td>
                        </tr>
                        <tr>
                          <td class="pl-0">Icon With Text</td>
                          <td class="pr-0 text-right"><div class="badge badge-pill badge-success">12<i class="icon-envelope ml-2"></i></div></td>
                        </tr>
                        <tr>
                          <td class="pl-0">Icon Badge</td>
                          <td class="pr-0 text-right"><div class="badge badge-pill badge-warning"><i class="icon-bubble"></i></div></td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
