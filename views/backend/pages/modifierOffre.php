...
<li class="nav-item">
	...
	<div class="card">
                <div class="card-body">
                  ...
                  chdir(__DIR__);
                   ?>
                   <form class="forms-sample" id="MyForms" action="../../modifierOffre.php" method="POST" enctype="multipart/form-data">
                    
                    <div class="form-group">
                      
                      <label for="exampleInputID">Identifiant</label>
                      <input type="test" class="form-control" id="exampleInputID" name ="id" placeholder="Identifiant" onfocusout="validerID()" required/>
                    ...
                    <div class="form-group">
                      <label for="exampleIDSlider">IdSlider</label>
                      <input type="text" class="form-control" id="exampleInputIDSlider" name ="idSlider"  placeholder="IdSlider"  onfocusout="valideridSlider()" required />
                      <span class="helper-text" > </span>
                    </div>

                    <div class="form-group">
                      <label for="exampleDescripition">Descripition</label>
                      <input type="text" class="form-control" id="exampleInputDescripition" name ="desc"  maxlength="100" required/>
                      <span class="helper-text" > </span>
                    </div>

                    <div class="form-group">
                      <label for="exampleDescripition">Reference du produit  </label>
                      <?php
                      chdir(__DIR__);
                    ...
                    <div class="form-group">
                      <label for="exampleDescripition">Prix ancien</label>
                      <input type="text" class="form-control" id="exampleInputPrix_anc" name ="prix"  maxlength="100" required/>
                      <span class="helper-text" > </span>
                    </div>

                     <div class="form-group">
                      <label for="exampleDescripition">Prix</label>
                      <input type="text" class="form-control" id="exampleInputPrix" name ="desc" maxlength="100" required/>
                      <span class="helper-text" > </span>
                    </div>
                    ...
                    <button type="submit" id="modifier" class="btn btn-primary mr-2" >Modifier</button>
                    <button class="btn btn-light" onclick="annuler()">Annuler</button>
