...
<li class="nav-item">
  ...
  <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="../../modifierCategorie.php">
                    <div class="form-group">
                      <input type="hidden" name="anciennom" >
          ...
          <!--<div id="closemodelsupprimer" style="font-size: 30px;transform: rotate(45deg);position: absolute;right: 14px; top: 0;cursor: pointer;" onclick="document.location.href='afficherProduits.php'">+</div>-->
                      <p style="position: relative;top:50% ;transform:translate(0,-60%);">Erreur de modification de categorie:Le nom existe deja!</p>
