...
$listeCategorie=$categorieC->afficherCategorieparnom($_POST['nom']);
chdir(__DIR__);
 ?>
...
<body>
  ...
  <div class="card">
                <div class="card-body">
                  ...
                  <form class="forms-sample" method="POST" action="../../modifierCategorie.php" onsubmit="return controleform()">
                    <div class="form-group">
                      <input type="hidden" name="anciennom" value="<?php echo $listeCategorie['nom'];?>">
                      <label for="exampleInputNom">Nom</label>
                      <input type="text" class="form-control" id="Nom" placeholder="Nom" name="nom" onfocusout="controleNom()" maxlength="50" value="<?php echo $listeCategorie['nom'];?>" required >
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="type">
                        <?php
                        if($listeCategorie['type']=="Vetement")
                        {
                        ?> 
                          <option selected="selected" value="Vetement">Vetement</option>
                          <option value="Assesoires">Accesoires</option>
                        <?php 
                        }
                        else
                        {
                        ?>
                          ...
                          <option selected="selected" value="Assesoires">Accesoires</option>
                        <?php
                        }
                        ?>
                      </select>
  ...
  <script type="text/javascript">
    ...
    function checkNomProduit(field)
    {
      ...
      else
      {
          ...
          {
            setInvalid(field,"Ce champs doit comporter seulement des lettres!");
            return false;
          }
      }
    }
