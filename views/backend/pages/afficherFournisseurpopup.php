...
<li class="nav-item">
  ...
  <div id="modelsupprimer_bg" class="modelsupprimer_bg" style="background-color: rgba(0,0,0,0.7);height: 100%;width: 100%;position: fixed;right: 0;bottom: 0;top: 0; z-index: 1000;justify-content: center;align-items: center;display: flex;">
        <div class="modelsupprimer-content" style="width: 400px;height: 200px;background-color: white;position: relative; border-radius: 5px;text-align: center;align-items: center;">
          <div id="closemodelsupprimer" style="font-size: 30px;transform: rotate(45deg);position: absolute;right: 14px; top: 0;cursor: pointer;" onclick="document.location.href='afficherFournisseur.php'">+</div>
          <p style="position: relative;top:50% ;transform:translate(0,-60%);">Etes vous sur de supprimer le fournisseur <strong><?php echo $_POST['reference']; ?></strong>?Cela va entamer la supprimer de tout les produits de ce fournisseur</p>
