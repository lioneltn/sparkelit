...
<body>
	...
	<div class="card">
                <div class="card-body">
                  ...
                  chdir(__DIR__);
                   ?>
                   <form class="forms-sample" id="MyForms" action="../../ajouterOffre.php" method="POST" enctype="multipart/form-data">
                    
                    <div class="form-group">
                      
                      <label for="exampleInputID">Identifiant</label>
                      <input type="test" class="form-control" id="exampleInputID" name ="id" placeholder="Identifiant" onfocusout="validerID()"/>
                   ...
                   <div class="form-group">
                    ...
                    <button type="submit" id="ajouter" class="btn btn-primary mr-2">Ajouter</button>
