                ...
                <div class="card-body">
                  ...
                  chdir(__DIR__);
                   ...
                   <form class="forms-sample" action="../../ajouterOffre.php" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      <label for="exampleInputIDSlider">IdSlider</label>
                    ...
                    <div class="form-group">
                      ...
                      <!--<input type="hidden" class="form-control" id="exampleInputRef" name ="refP"  maxlength="100" required/>-->
                      <?php 
                      chdir(__DIR__);
