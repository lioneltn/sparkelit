                  ...
                  <div calss="row">
                    <div class="form-group" style="display: flex;">
                      <div class="col-md-3 grid-margin" style="padding-right: 10px;">
                        <input class="form-control" type="text" name="recherche" id="rechercherRefProduit" placeholder="Reference du produit" onkeyup="rechercherParRef(this.value);">
                      </div>
                      <div class="col-md-3 grid-margin" style="padding-right: 10px; ">
                        <input class="form-control" type="text" name="recherche" id="rechercherParNom" placeholder="Nom" onkeyup="rechercherParNom(this.value);">
                      </div>
...
function rechercherParNom(str)
    {
      ...
      document.getElementById("rechercherRefProduit").value="";
      if(str=="")
      {
...
function rechercherParRef(str)
    {
      //var x=document.getElementById("sortable-table-2");
      
      document.getElementById("rechercherParNom").value="";
      if(str=="")
      {
          //x.style.display="block";
          var xmlhttp = new XMLHttpRequest();
