 ...
 <!-- <li class="nav-item">
              ...
              <div class="submenu">
                <ul class="submenu-item">
                  ...
                  <li class="nav-item"><a class="nav-link" href="modifierpost.php">Modifier post</a></li>
                  <li class="nav-item"><a class="nav-link" href="pages/forms/wizard.php">Afficher posts</a></li>
                  <!--<li class="nav-item"><a class="nav-link" href="pages/forms/text_editor.php">Text Editor</a></li>
                  <li class="nav-item"><a class="nav-link" href="pages/forms/code_editor.php">Code Editor</a></li>
                </ul>
              </div>
...
<li class="nav-item">
            ...
            <li class="nav-item">
              <a href="ajouterSlider.php" class="nav-link"><i class="link-icon icon-book-open"></i><span class="menu-title">Slider</span><i class="menu-arrow"></i></a>
              <div class="submenu">
                <ul class="submenu-item">
                  <li class="nav-item"><a class="nav-link" href="ajouterSlider.php"> Ajouter slider</a></li>
                  <li class="nav-item"><a class="nav-link" href="afficherSlider.php">Afficher slider</a></li>
                  <!--<li class="nav-item"><a class="nav-link" href="pages/forms/text_editor.php">Text Editor</a></li>
                  <li class="nav-item"><a class="nav-link" href="pages/forms/code_editor.php">Code Editor</a></li>-->
                </ul>
              </div>
	...
	<div class="card">
                <div class="card-body">
                  ...
                  chdir(__DIR__);
                   ?>
                  <form class="forms-sample" method="POST" action="../../ajoutProduit.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleInputReference" placeholder="Reference" name="reference" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                      ...
                      <textarea class="form-control" id="exampleDescription" rows="4" name="description" required></textarea>
                    </div>
                          ...
                          <div class="col-md-3 grid-margin">
                            <div class="card">
                              <div class="card-body">
                                ...
                                <div>
                                  <br><label>S</label><br>
                                  <input type="number" class="form-control" min="0" step="1"  name="Tailles1" >
                                </div>
          
                                <div>
                                  <br><label>M</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillem1" >
                                </div>

                                <div>
                                  <br><label>L</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillel1" >
                                </div>

                                <div>
                                  <br><label>XL</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillexl1" >
                                </div>
                                <br>
                                <div>
                          ...
                          <div class="col-md-3 grid-margin">
                            <div class="card">
                              <div class="card-body">
                                ...
                                <div>
                                  <br><label>S</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Tailles2">
                                </div>
          
                                <div>
                                  <br><label>M</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillem2">
                                </div>

                                <div>
                                  <br><label>L</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillel2">
                                </div>

                                <div>
                                  <br><label>XL</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillexl2" >
                                </div>
                                <br>
                                <div>
                          ...
                          <div class="col-md-3 grid-margin">
                            <div class="card">
                              <div class="card-body">
                                ...
                                <div>
                                  <br><label>S</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Tailles3" >
                                </div>
          
                                <div>
                                  <br><label>M</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillem3" >
                                </div>

                                <div>
                                  <br><label>L</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillel3">
                                </div>

                                <div>
                                  <br><label>XL</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillexl3">
                                </div>
                                <br>
                                <div>
                          ...
                          <div class="col-md-3 grid-margin">
                            <div class="card">
                              <div class="card-body">
                                ...
                                <div>
                                  <br><label>S</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Tailles4">
                                </div>
          
                                <div>
                                  <br><label>M</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillem4">
                                </div>

                                <div>
                                 <br><label>L</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillel4">
                                </div>

                                <div>
                                  <br><label>XL</label><br>
                                  <input type="number" class="form-control" min="0" step="1" name="Taillexl4" >
                                </div>
                                <br>
                                <div>
