...
<li class="nav-item">
	...
	<div class="card">
                <div class="card-body">
                  ...
                  chdir(__DIR__);
                   ?>
                   <form class="forms-sample" action="../../modifierSlider.php" method="POST" enctype="multipart/form-data">
                    
                    <div class="form-group">
                      
                      <label for="exampleInputID">Reference</label>
                      <input type="test" class="form-control" id="exampleInputID" name ="ref" value="<?PHP echo $_POST["ref"]; ?>" placeholder="Reference"/>
                  ...
                  <script >
                        ...
                        function confirmermodifierSlider()
{
  
  swal({
    //swal("Hello world!");
  title: "Slider modifiée!",
  ...
  icon: "success",
                    ...
                    <button type="submit" name="modifier" id="modifier" onclick="confirmermodifierSlider()" class="btn btn-primary mr-2" >Modifier</button>
