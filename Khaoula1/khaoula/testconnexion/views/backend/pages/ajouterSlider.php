   ...
   <li class="nav-item">
	...
	<div class="card">
                <div class="card-body">
                  ...
                  chdir(__DIR__);
                   ?>
                   <form class="forms-sample" action="../../ajouterSlider.php" method="POST" enctype="multipart/form-data">
                    
                    <div class="form-group">
                      
                      <label for="exampleInputID">Reference</label>
                      <input type="test" class="form-control" id="exampleInputID" name ="ref" placeholder="Reference" onfocusout="validerID()"/>
...
<script >
                  function confirmerajoutSlider()
                  {
                  swal({
    //swal("Hello world!");
  title: "slider ajoutée!",
  ...
  icon: "success",
                    ...
                    <button type="submit" id="ajouter" class="btn btn-primary mr-2" onclick="confirmerajoutSlider()">Ajouter</button>
                    <button class="btn btn-light" onclick='location.href="ajouterSlider.php"'>Annuler</button>
