...
<html>
<head>
	<title>Ajouter Metadonnee</title>
	  <meta charset="utf-8">
	...
	<div class="card">
                <div class="card-body">
                  ...
                  <p class="card-description">
                    Ajouter un metadonnee
                  </p>
                  <?php 
                  chdir(__DIR__);
                   ?>
                   <form class="forms-sample" action="../../ajouterMetadonnee.php" method="POST" enctype="multipart/form-data">
                    
                    <div class="form-group">
                      
                      <label for="exampleInputID">Reference</label>
                      <input type="text" class="form-control" id="exampleInputID" name ="ref" placeholder="Reference" onfocusout="validerID()"/>
                    ...
                    <div class="form-group">
                     ...
                     <script >
                        ...
                        function confirmerajouterMeta()
{
  
  swal({
    //swal("Hello world!");
  title: "Metadonnee ajoutée!",
  ...
  icon: "success",
                    ...
                    <button type="submit" id="ajouter" class="btn btn-primary mr-2" onclick="confirmerajouterMeta()" >Ajouter</button>
                    <button class="btn btn-light" onclick='location.href="ajouterMetadonnee.php"'>Annuler</button>
