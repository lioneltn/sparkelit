                  ...
                  <form class="forms-sample">
                  	<div class="form-group">
                        ...
                        ?>
                          ...
                          elseif ($liste['type']=="Accesoires")
                          {
                            ?>
                            <option value="Homme"> Homme
                            <option value="Femme"> Femme
                            <option value="Accesoires" selected="selected"> Accesoires
                            <?php
                          }
                            ?>
						</select>
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="reference" value="<?php echo $liste['reference'];?>" readonly>
                    </div>
                    <div class="form-group">
                      <label for="exampleInputNom">Nom</label>
                      <input type="text" class="form-control" id="exampleInputNom" placeholder="Nom"  value="<?php echo $liste['nom'];?>">
                    </div>
                    <div class="form-group">
                      <label for="exampleDescription">Description</label>
                      <textarea class="form-control" id="exampleDescription" rows="4"> <?php echo $liste['description'];?></textarea>
                    </div>
                    ...
                    <div class="form-group">
                    	<div class="card">
                			<div class="card-body">
                  				...
                  				<input type="file" class="dropify" value="image.jpg"/>
                			</div>
              			</div>
                    </div>
                    	...
                    	<li class="listecouleur">
                    	  <div class="form-check form-check-primary">
                            <label class="form-check-label">
                              <input type="radio" name="choixcouleur" class="form-check-input">
                              Bleu
                            </label>
                          </div>
                        </li>
