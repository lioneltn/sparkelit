                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="exampleAdresse" placeholder="Adresse">
                    </div>

                    <div class="form-group">
                      <label for="exampleNumber">Numero</label>
                      <input type="text" class="form-control" id="exampleNumber" placeholder="Numero">
                    </div>
                    ...
                    <button type="submit" id="ajouter" class="btn btn-primary mr-2" onclick="modifierfournisseur()">Ajouter</button>
                    <button class="btn btn-light">Annuler</button>
                    <button class="btn btn-danger" onclick="confirmerfournisseur()">Supprimer</button>
