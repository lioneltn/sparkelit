...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/x-icon" href="../meta/Logoreduit.png"><!--/icons/favicon.ico-->
                ...
                <div class="container-fluid">
                    ...
                    <div class="header-center" style="width: 92px;height: 49px">
                        <a href="index.php" class="logo">
                            <img src="assets/images/logoclient.png" alt="Porto Logo " style="width: 100px;height: 70px">
                        </a>
                            ...
                            <div class="products-slider owl-carousel owl-theme owl-nav-top">
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.php">Brown Men's Jeans</a>
                                        </h2>
                                        <div class="price-box">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.php">Black Men's Shirts</a>
                                        </h2>
                                        <div class="price-box">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.php">Blue Men's Shirts</a>
                                        </h2>
                                        <div class="price-box">
                            ...
                            <div class="products-slider owl-carousel owl-theme owl-nav-top">
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.php">White Ladies Top</a>
                                        </h2>
                                        <div class="price-box">
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.php">Black Lady Top</a>
                                        </h2>
                                        <div class="price-box">
                                            <span class="product-price">$110.00</span>
                                        </div><!-- End .price-box 
                                ...
                                <div class="product">
                                    ...
                                    <div class="product-details">
                                        ...
                                        <h2 class="product-title">
                                            <a href="product.php">Blue Shirts</a>
                                        </h2>
                                        <div class="price-box">
                                            <span class="product-price">$80.00</span>
                                        </div><!-- End .price-box 
