                ...
                <div class="card-body">
                  ...
                  <form class="forms-sample">
                    <div class="form-group row">
                      <label for="exampleInputUsername2" class="col-sm-3 col-form-label">selectionner Login</label>
                      <div class="col-sm-9">
                        ...
                        <!--<input type="text" class="form-control" id="login" placeholder="Id-poste" required>-->
                      </div>
                    </div>
                    <div class="form-group row">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Modifier numero</label>
                      <div class="col-sm-9">
                        <input type="number" class="form-control" id="numero"  placeholder="Modifier numero" pattern="\d*" maxlength="8" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Modifier mot de passe(7 characters minimum)</label>
                      <div class="col-sm-9">
                        <input type="password" class="form-control" id="mdp" placeholder="mot de passe" minlength="7" maxlength="10" required>
                      </div>
                    </div>
                    <div class="form-group row">
                      <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">confirmer mot de passe</label>
                      <div class="col-sm-9">
                        <input type="password" class="form-control" id="confirmer_mpd" placeholder="mot de passe" minlength="7" maxlength="10" required>
                      </div> 
                    </div>
                    <div class="card">
                <div class="card-body">
                  <h4 class="card-title">Modifier l'image de l'artiste</h4>
                  <input type="file" class="dropify" id="image" required/>
                </div>
              </div>
