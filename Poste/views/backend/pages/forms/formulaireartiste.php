	...
	<div class="card">
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    ...
                    <div class="form-group row">
                      <label for="exampleInputMobile" class="col-sm-3 col-form-label">Numéro</label>
                      <div class="col-sm-9">
                    ...
                    <div class="form-group row">
                      <label for="exampleInputPassword2" class="col-sm-3 col-form-label">Mot de passe(7 characters minimum)</label>
                      <div class="col-sm-9">
                ...
                <div class="card-body">
                  ...
                  <input type="file" class="dropify" id="image" required/>
                    ...
                    <button type="submit" class="btn btn-primary mr-2" onclick="controle3()" >Ajouter</button>
